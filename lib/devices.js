...
const light = require("./Devices/type/light");
const airPurifier = require("./Devices/type/airPurifier");
const humidifier = require("./Devices/type/humidifier");
const powerPlug = require("./Devices/type/powerPlug");
const powerStrip = require("./Devices/type/powerStrip");
